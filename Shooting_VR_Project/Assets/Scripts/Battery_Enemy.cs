...
public class Battery_Enemy : AirFighter
{
    float shootTime = 0;
    ...
    protected override void Update()
    {
        ...
        if (Distance_Player() < 20)
        {
            ...
            if (shootTime > 2)
            {
                ...
                Instantiate(bullet, muzzle.transform.position + transform.right * 0.1f, muzzle.transform.rotation);
                Instantiate(bullet, muzzle.transform.position - transform.right * 0.1f, muzzle.transform.rotation);
                return;
            }
...
#if UNITY_EDITOR
    [CustomEditor(typeof(Tough_Enemy))]
    public class Tough_Enemy_Inspector : AirFighter_Inspector
    {
        public override void SetComponent()
        {
            base.SetComponent();
            component = target as Tough_Enemy;
        }
    }

    public class EditorGizmo_Tough_Enemy : EditorGizmo_AirFighter { }
